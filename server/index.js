...
var Aggregate = mongoose.model('Aggregate', { fields: Object, date: Number, session: Number, email: String });
...
app.post('/', function (req, res) {
    ...
    var agg_to_save = new Aggregate({ fields: to_add, date: Date.now(),
...
app.post('/create_session', function (req, res) {
    try {
        var new_key = new PublicKey({session: req.body.session, pub_key: req.body.pub_key, _id: req.body.session});
    } catch (err) {
        res.send(err);
    }
