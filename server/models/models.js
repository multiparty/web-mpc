...
var env = process.env.PORT==null?'mongodb://mongo:27017/aggregate':'mongodb://localhost:27017/aggregate';

(async function () {
  try {
    console.log(env);
    await mongoose.connect('mongodb://localhost:27017/aggregate', { useMongoClient: true });
  } catch (err) {
