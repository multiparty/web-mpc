define(['jquery', 'clientController', 'helper/sail_hot', 'helper/drop_sheet', 'Spinner', 'ResizeSensor'], function ($, clientController, sailHOT, DropSheet, Spinner, ResizeSensor) {
