...
const tableTemplate = require('../../client/app/data/single_cell.js');
  ...
  describe('End-to-end Workflow', function () {
    ...
    it('Unmasking', async function () {
      ...
      for (const cohort of cohorts) {
        const cohortAverage = compute.computeAverageAgainstTable(inputs[cohort]);
